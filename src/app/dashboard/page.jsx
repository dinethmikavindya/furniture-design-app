          ...
          <div style={{ flex: 1, padding: "32px 32px 28px 28px", display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 4 }}>
              <motion.button
                ...
                onClick={() => { onClose(); onNavigate("/editor"); }}
                style={{
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: 12, marginTop: 6 }}>
        ...
        <GlassButton variant="primary" onClick={onOpenModal}>
...
export default function HomeScreen() {
  ...
  return (
    <SidebarLayout>
      ...
      {/* ── New Space Modal (AnimatePresence = glide in/out) ── */}
      <AnimatePresence>
        {showModal && (
          <NewSpaceModal
