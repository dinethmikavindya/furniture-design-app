...
/* ─── PROJECT CARD ─── */
function ProjectCard({ project, selected, onClick, view, dark }) {
    ...
    return (
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 14, fontWeight: 700, color: dark ? "#f0eaff" : "#2d1f4e", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis"
 }}>
            {project.name}
          </div>
  ...
  return (
    <motion.div
      ...
      style={{
        borderRadius: 20,
background: selected ? "rgba(139,92,246,0.08)" : dark ? "rgba(30,20,60,0.5)" : "rgba(255,255,255,0.32)",
backdropFilter: "blur(24px)",
border: selected ? "1.5px solid rgba(139,92,246,0.35)" : dark ? "1.5px solid rgba(139,92,246,0.15)" : "1.5px solid rgba(255,255,255,0.70)",
        cursor: "pointer",
        overflow: "hidden",
    ...
    >
      ...
      <div style={{
        height: 130,
background: dark ? `linear-gradient(135deg, #1e1040 0%, #0f0a1a 100%)` : `linear-gradient(135deg, ${project.thumb} 0%, rgba(255,255,255,0.6) 100%)`,
        display: "flex", alignItems: "center", justifyContent: "center",
      ...
      <div style={{ padding: "12px 14px" }}>
        <div style={{ fontSize: 14, fontWeight: 700, color: dark ? "#f0eaff" : "#2d1f4e", marginBottom: 2,
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span style={{
            fontSize: 11, fontWeight: 600, color: dark ? "#a78bfa" : "#6b5b95",
...
background: dark ? "linear-gradient(135deg,#0f0a1a 0%,#0a1020 50%,#120a1a 100%)" : "linear-gradient(135deg,#f0eaff 0%,#eaf0ff 50%,#f5eaff 100%)",
      position: "relative",
    }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", zIndex: 10, position: "relative" }}>
        ...
        <motion.header
          ...
          style={{
            ...
            padding: "0 28px",
            background: dark ? "rgba(15,10,30,0.6)" : "rgba(255,255,255,0.18)",
backdropFilter: "blur(24px) saturate(180%)",
borderBottom: dark ? "1px solid rgba(139,92,246,0.15)" : "1px solid rgba(255,255,255,0.45)",
            boxShadow: "0 2px 20px rgba(120,80,220,0.06)",
          }}
        >
          <div>
            <h1 style={{ fontSize: 26, fontWeight: 800, color: dark ? "#f0eaff" : "#2d1f4e", letterSpacing: "-0.5px", lineHeight: 1 }}>
              Your Spaces
            </h1>
            <p style={{ fontSize: 12, color: dark ? "#6b5b95" : "#9b93b8", marginTop: 2 }}>
...
border: dark ? "1px solid rgba(139,92,246,0.25)" : "1px solid rgba(255,255,255,0.70)",
              ...
              <div style={{
                ...
                <input
                  ...
                  style={{
                    ...
                    border: dark ? "1.5px solid rgba(139,92,246,0.2)" : "1.5px solid rgba(255,255,255,0.65)",
background: dark ? "rgba(30,20,60,0.5)" : "rgba(255,255,255,0.45)", backdropFilter: "blur(16px)",
fontFamily: "'Afacad',sans-serif", fontSize: 13, color: dark ? "#f0eaff" : "#2d1f4e",
                    outline: "none",
                ...
                {["All", "In Progress", "Draft", "Complete"].map(f => (
                  <motion.button key={f}
                    ...
                    style={{
                      ...
                      background: filter === f ? "linear-gradient(135deg,#8b5cf6,#6d28d9)" : dark ? "rgba(30,20,60,0.5)" : "rgba(255,255,255,0.45)",

color: filter === f ? "#fff" : dark ? "#a78bfa" : "#6b5b95",
                      backdropFilter: "blur(12px)",
                      border: filter === f ? "none" : dark ? "1px solid rgba(139,92,246,0.25)" : "1px solid rgba(255,255,255,0.65)",
                      boxShadow: filter === f
              ...
              <div style={{
                display: "flex", gap: 2,
background: dark ? "rgba(30,20,60,0.5)" : "rgba(255,255,255,0.45)", backdropFilter: "blur(12px)",
border: dark ? "1px solid rgba(139,92,246,0.2)" : "1px solid rgba(255,255,255,0.65)", borderRadius: 50, padding: "3px",
...
background: dark ? `linear-gradient(135deg,#1e1040 0%,#0f0a1a 100%)` : `linear-gradient(135deg,${selectedProject.thumb} 0%,rgba(255,255,255,0.7) 100%)`,
                  display: "flex", alignItems: "center", justifyContent: "center",
                ...
                <div style={{ padding: "18px 20px", flex: 1, overflowY: "auto", display: "flex", flexDirection: "column", gap: 16 }}>
                  <div>
                    <h2 style={{ fontSize: 18, fontWeight: 800, color: dark ? "#f0eaff" : "#2d1f4e", marginBottom: 4 }}>
...
background: dark ? "rgba(30,20,60,0.5)" : "rgba(255,255,255,0.45)", border: dark ? "1px solid rgba(139,92,246,0.2)" : "1px solid rgba(255,255,255,0.70)",
                        boxShadow: "0 2px 8px rgba(120,80,220,0.04)",
                      }}>
                        <div style={{ fontSize: 14, fontWeight: 800, color: dark ? "#f0eaff" : "#2d1f4e" }}>{s.value}</div>
                        <div style={{ fontSize: 9, fontWeight: 600, color: dark ? "#a78bfa" : "#9b93b8", textTransform: "uppercase", letterSpacing: "0.5px" }}>{s.label}</div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div style={{
                    ...
                    <span style={{ fontSize: 12, color: dark ? "#a78bfa" : "#6b5b95", fontWeight: 500 }}>
                      ...
                      {[
                        ...
                        <motion.button key={btn.label}
                          ...
                          style={{
                            ...
                            fontFamily: "'Afacad',sans-serif", fontSize: 12, fontWeight: 600,
                            cursor: "pointer",
background: dark ? "rgba(30,20,60,0.5)" : "rgba(255,255,255,0.55)",
color: dark ? "#a78bfa" : "#6b5b95",
border: dark ? "1px solid rgba(139,92,246,0.2)" : "1px solid rgba(255,255,255,0.70)",
      ...
      <AnimatePresence>
        {showDeleteConfirm && (
          ...
          >
            ...
            >
              <div style={{ fontSize: 40, marginBottom: 12 }}>🗑</div>
              <h3 style={{ fontSize: 18, fontWeight: 800, color: dark ? "#f0eaff" : "#2d1f4e", marginBottom: 6
 }}>
