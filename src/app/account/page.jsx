...
export default function AccountPage() {
  ...
  const inputStyle = {
    ...
    background: dark ? "rgba(30,20,60,0.5)" : "rgba(255,255,255,0.35)",
    fontSize: 14, fontFamily: "'Afacad', sans-serif",
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          <div>
            <div style={{ fontSize: 26, fontWeight: 800, color: dark ? "#f0eaff" : "#2d1f4e", letterSpacing: "-0.3px" }}>Account</div>
            <div style={{ fontSize: 14, color: dark ? "#6b5b95" : "#9b93b8", marginTop: 4 }}>Manage your profile and preferences</div>
          </div>
          ...
          <motion.button
            ...
            style={{
              ...
              border: dark ? "1.5px solid rgba(139,92,246,0.2)" : "1.5px solid rgba(255,255,255,0.65)",
              backdropFilter: "blur(12px)",
              boxShadow: "0 2px 12px rgba(120,80,220,0.08)",
            }}
          >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: 20, marginBottom: 20 }}>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
            style={{
              borderRadius: 20,
              background: dark ? "rgba(20,12,45,0.7)" : "rgba(255,255,255,0.22)",
              backdropFilter: "blur(32px)",
              border: dark ? "1.5px solid rgba(139,92,246,0.2)" : "1.5px solid rgba(255,255,255,0.65)",
              boxShadow: "0 8px 32px rgba(120,80,220,0.08)",
              padding: "28px 32px",
            }}>
            <div style={{ fontSize: 16, fontWeight: 700, color: dark ? "#f0eaff" : "#2d1f4e", marginBottom: 20 }}>Profile</div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 18, marginBottom: 24 }}>
              ...
              <div>
                <div style={{ fontSize: 18, fontWeight: 700, color: dark ? "#f0eaff" : "#2d1f4e" }}>{user?.name || "User"}</div>
                <div style={{ fontSize: 13, color: dark ? "#6b5b95" : "#9b93b8", marginTop: 2 }}>{user?.email || ""}</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {[
                ...
                <div key={label} style={{
                  ...
                  background: dark ? "rgba(30,20,60,0.5)" : "rgba(255,255,255,0.35)",
                  border: dark ? "1px solid rgba(139,92,246,0.15)" : "1px solid rgba(255,255,255,0.6)",
                }}>
                  <div style={{ fontSize: 10, fontWeight: 700, color: dark ? "#6b5b95" : "#9b93b8", letterSpacing: "0.5px", textTransform: "uppercase", marginBottom: 4 }}>{label}</div>
                  <div style={{ fontSize: 13, fontWeight: 600, color: dark ? "#f0eaff" : "#2d1f4e", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{value}</div>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}
            ...
            <div style={{ fontSize: 16, fontWeight: 700, color: dark ? "#f0eaff" : "#2d1f4e", marginBottom: 20 }}>Change Password</div>

            <form onSubmit={handleChangePassword} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div>
                <div style={{ fontSize: 11, fontWeight: 700, color: dark ? "#6b5b95" : "#9b93b8", letterSpacing: "0.6px", textTransform: "uppercase", marginBottom: 6 }}>Current Password</div>
              ...
              <div>
                <div style={{ fontSize: 11, fontWeight: 700, color: dark ? "#6b5b95" : "#9b93b8", letterSpacing: "0.6px", textTransform: "uppercase", marginBottom: 6 }}>New Password</div>
                <input type="password" value={newPw} onChange={e => setNewPw(e.target.value)} placeholder="Min 8 characters" required style={inputStyle} />
              </div>
              <div>
                <div style={{ fontSize: 11, fontWeight: 700, color: dark ? "#6b5b95" : "#9b93b8", letterSpacing: "0.6px", textTransform: "uppercase", marginBottom: 6 }}>Confirm New Password</div>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
          style={{
            borderRadius: 20,
            background: dark ? "rgba(40,10,10,0.5)" : "rgba(255,240,240,0.18)",
            backdropFilter: "blur(32px)",
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
            <div>
              <div style={{ fontSize: 14, fontWeight: 600, color: dark ? "#f0eaff" : "#2d1f4e", marginBottom: 4 }}>Delete Account</div>
              <div style={{ fontSize: 13, color: dark ? "#6b5b95" : "#9b93b8" }}>Permanently delete your account and all your projects. This cannot be undone.</div>
            </div>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setShowDelete(false)}
            ...
            <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, opacity: 0 }} onClick={e => e.stopPropagation()}
              style={{
                ...
                background: dark ? "rgba(20,12,45,0.95)" : "rgba(255,255,255,0.9)",
                backdropFilter: "blur(40px)",
                border: dark ? "1.5px solid rgba(139,92,246,0.2)" : "1.5px solid rgba(255,255,255,0.8)",
                boxShadow: "0 32px 80px rgba(120,80,220,0.2)",
                padding: "32px",
              }}>
              <div style={{ fontSize: 18, fontWeight: 800, color: "#dc2626", marginBottom: 10 }}>Delete Account</div>
              <div style={{ fontSize: 14, color: dark ? "#a89bc8" : "#6b5b95", marginBottom: 20, lineHeight: 1.6 }}>This will permanently delete your account. Type your email to confirm.</div>
              <div style={{ marginBottom: 16 }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: dark ? "#6b5b95" : "#9b93b8", letterSpacing: "0.6px", textTransform: "uppercase", marginBottom: 6 }}>Your Email</div>
                <input type="email" value={deleteEmail} onChange={e => { setDeleteEmail(e.target.value); setDeleteError(""); }} placeholder={user?.email || "your@email.com"} style={inputStyle} />
              </div>
              ...
              <div style={{ display: "flex", gap: 10 }}>
                <button onClick={() => { setShowDelete(false); setDeleteEmail(""); setDeleteError(""); }}
                  style={{ flex: 1, padding: "11px", borderRadius: 50, border: "1.5px solid rgba(139,92,246,0.3)", background: "transparent", color: dark ? "#a78bfa" : "#6b5b95", cursor: "pointer", fontSize: 13, fontWeight: 700, fontFamily: "'Afacad', sans-serif" }}>
                  Cancel
                </button>
