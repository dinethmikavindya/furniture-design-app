...
export default function ResetPasswordForm() {
  ...
  const css = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .reset-input::placeholder { color: #b8aed0; }
    .reset-input:focus {
  ...
  /* success state — show a different card */
        ...
        <AnimatePresence mode="wait">
          ...
          {isSuccess ? (
            ...
            >
              ...
              <div style={{ fontSize: 22, fontWeight: 700, color: '#2d1f4e', marginBottom: 8 }}>
                Password Reset!
              </div>
              <div style={{ fontSize: 14, color: '#9b93b8', fontWeight: 500, lineHeight: 1.6 }}>
                {message}
                <br />
                <span style={{ fontSize: 12, color: '#c4b5fd' }}>Redirecting to login…</span>
              </div>

              {/* Progress bar */}
              <div style={{ marginTop: 24, height: 3, borderRadius: 3, background: 'rgba(196,181,253,0.3)', overflow: 'hidden' }}>
                <motion.div
                  initial={{ width: '0%' }}
                  animate={{ width: '100%' }}
                  transition={{ duration: 1.5, ease: 'linear' }}
                  style={{ height: '100%', borderRadius: 3, background: 'linear-gradient(90deg,#8b5cf6,#ec4899)' }}
                />
              </div>
            </motion.div>
            ...
            <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              ...
              >
                ...
                <div style={{ marginTop: 8, fontSize: 13, color: '#9b93b8', fontWeight: 500 }}>
